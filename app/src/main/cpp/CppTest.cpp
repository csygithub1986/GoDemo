...
Point2f  *FindConor(Point2f *directionLeft, Point2f *directionRight, Point2f *directionUp, Point2f *directionDown)
{
    ...
    {
        for (list<Point>::iterator i = iterRight->second.begin(); i != iterRight->second.end(); ++i)
        {
            Point p = *i;
    ...
    {
        for (list<Point>::iterator i = iterLeftUp->second.begin(); i != iterLeftUp->second.end(); ++i)
        {
            Point p = *i;
            upPoints.push_back(Point2f(p.x, p.y));
        }
    ...
    {
        for (list<Point>::iterator i = iterRightUp->second.begin(); i != iterRightUp->second.end(); ++i)
        {
            Point p = *i;
            upPoints.push_back(Point2f(p.x, p.y));
        }
    ...
    {
        for (list<Point>::iterator i = iterLeftDown->second.begin(); i != iterLeftDown->second.end(); ++i)
        {
            Point p = *i;
            downPoints.push_back(Point2f(p.x, p.y));
        }
    ...
    {
        for (list<Point>::iterator i = iterRightDown->second.begin(); i != iterRightDown->second.end(); ++i)
        {
            Point p = *i;
            downPoints.push_back(Point2f(p.x, p.y));
        }
